...
export const metadata = {
  title: 'Mentions Bot for Slack',
  description: 'Never miss a mention — get notified instantly or as a daily digest.',
};
...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      ...
      <body>
        <header>
          <div className="logo"><SlackIcon /></div>
          <span className="logo-name">Mentions Bot</span>
        </header>
        {children}
        <footer>Mentions Bot &middot; Built with the Slack Events API</footer>
      </body>
    </html>
  );
}
